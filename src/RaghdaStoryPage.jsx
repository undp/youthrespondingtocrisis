      ...
      {line.split(' ').map((word, wordIndex) => (
        <span
          className={`story-section-two-opening-word${
            sectionTwoOpeningAccentWords.has(word) ? ' story-section-two-opening-word-accent' : ''
          }`}
          key={`${word}-${wordIndex}`}
        >
          {word}
...
function RaghdaStoryPage() {
  ...
  useEffect(() => {
    ...
    const context = gsap.context(() => {
      ...
      const storyLeadersSection = document.querySelector('.story-leaders-section')
      ...
      if (sectionTwo) {
        ...
        const sectionTwoQuote = sectionTwo.querySelector('.story-section-two-quote p')
        const sectionTwoOpening = sectionTwo.querySelector('.story-section-two-opening')
        const sectionTwoOpeningBracket = sectionTwo.querySelector('.story-section-two-bracket-opening')
        const sectionTwoOpeningWords = sectionTwo.querySelectorAll('.story-section-two-opening-word')
        const sectionTwoOpeningAccentWords = sectionTwo.querySelectorAll(
          '.story-section-two-opening-word-accent',
        )
        const sectionTwoIntroItems = sectionTwo.querySelectorAll('.story-section-two-intro p')
      ...
      if (sectionThree) {
        const sectionThreeQuoteLines = sectionThree.querySelectorAll('.story-section-three-quote-line-desktop')
        ...
        const sectionThreeQuoteMobileLines = sectionThree.querySelectorAll('.story-section-three-quote-line-mobile')
      ...
      if (visionSection) {
        ...
        const setupVisionReveal = (lineSelector, scrollDistance) => {
          const visionLines = gsap.utils.toArray(
            visionSection.querySelectorAll(`${lineSelector} .story-vision-line`),
          )
          ...
          visionLines.forEach((line) => {
            const lineWords = gsap.utils.toArray(line.querySelectorAll('.story-vision-word'))
      ...
      if (storyLeadersSection) {
        const storyLeadersScroller = storyLeadersSection.querySelector('.story-leaders-grid-wrap')
        const storyLeadersGrid = storyLeadersSection.querySelector('.story-leaders-grid')
        const storyLeadersCopyItems = storyLeadersSection.querySelectorAll('.story-leaders-copy h2')
        const storyLeaderCards = storyLeadersSection.querySelectorAll('.story-leader-card')
        ...
        if (storyLeadersScroller && storyLeadersGrid) {
          const getStoryLeadersTravel = () =>
            Math.max(0, storyLeadersScroller.scrollWidth - storyLeadersScroller.clientWidth)
          const getStoryLeadersStart = () => {
            ...
            const carouselBottom =
              storyLeadersScroller.offsetTop + storyLeadersScroller.offsetHeight
          ...
          storyLeadersScroller.querySelectorAll('img').forEach((image) => {
            ...
            image.addEventListener('load', refreshStoryLeadersScroll, { once: true })
            image.addEventListener('error', refreshStoryLeadersScroll, { once: true })
  ...
  const handleReadFullStoryClick = () => {
    ...
    const top = impactSection.getBoundingClientRect().top + window.scrollY + sectionOffset
  ...
  return (
    <main className="story-detail-page">
      ...
      >
        <header className="hero-site-header story-detail-site-header" aria-label="Microsite header">
          <a
      ...
      <section id="story-impact" className="story-impact-section" aria-labelledby="story-impact-title">
        <div className="story-impact-inner">
          <div className="story-impact-copy">
            ...
            <p className="story-impact-lead">
              Communities have been increasingly affected by climate-related challenges, while
              integrated efforts led by United Nations Development Programme and its partners are
              improving water access, restoring ecosystems, strengthening livelihoods, and
              empowering youth to lead climate action and resilience initiatives.
            </p>
          </div>
          ...
          <div className="story-impact-stats" aria-label="Impact statistics">
            {impactStats.map((stat) => (
              <article className="story-impact-stat" key={`${stat.value}-${stat.label}`}>
                <h2>
      ...
      >
        <div className="story-narrative-copy">
          <p>
            In the spring of 2023, the Shabelle River in central Somalia burst its banks,
            inundating entire neighborhoods of Beledweyne, the capital of the Hiraan region.
            Thousands of families were displaced, as floodwaters surged through homes and farmland.
          </p>

          <p>
            For many residents, this flood is not an isolated disaster. It is part of a relentless
            pattern that has repeatedly submerged their streets, ruined their crops, and stranded
            their families. Beledweyne has been through too many cycles of prolonged droughts, flash
            floods and tensions over dwindling resources. Efforts to rebuild and to reconcile are
            being suffocated, keeping the city shackled to the frontlines of Somalia&apos;s ongoing
            political resilience.
          </p>

          <p>
            Somalia stands at a perilous confluence of political fragmentation, armed conflict,
            economic precarity, and escalating climate disasters. 26-year-old Abdirahman Yusuf
            stands at the intersection of the country&apos;s greatest poly-crisis challenges, and its
      ...
      >
        ...
        <div className="story-section-two-inner">
          ...
          <div className="story-section-two-intro">
            <p>
              He was only eighteen when, in 2017, he and six friends established Maan-Dhis, a
              youth-led organization that aimed to unite young people from across Somalia, to drive
              solutions in their communities.
            </p>

            <p>
              In its early years, Maan-Dhis focused on peacebuilding, organizing community-based
              dialogues to reduce conflicts. By 2020, the organization reformed its strategy around
              four main pillars: peacebuilding and conflict solutions, environmental sustainability
              and climate action, socioeconomic development and livelihood, and good governance and
              women&apos;s empowerment.
            </p>
          </div>
          ...
          <blockquote className="story-section-two-quote">
            ...
            />
            <p>
              "In Somalia, our children, our young people and women, they have the potential to
              address challenges facing our communities, but the opportunities and experiences they
              have are limited. That is why our organization Maan-Dhis is committed to engaging
              youth and grassroots communities to build their capacity and engage them in dialogue
        ...
        <div className="story-section-two-bottom-panel">
          <div className="story-section-two-bottom">
            <p>
              Today, Maan-Dhis has around 3,000 youth members across Somalia and works closely with
              government, local communities, and international partners like UNDP.
            </p>

            <p>
              Its initiatives include climate action advocacy, clean-up campaigns, climate
              education, solar street-lighting projects, and livelihood programs that have trained
              more than 1,500 young people, including women, displaced persons, and persons with
              disabilities.
            </p>

            <p>
              Abdirahman serves as an Africa Climate Champion under UNDP sponsorship, leading
              research and dialogue on community-based climate innovation. He has represented
              Somalia in COPs assemblies since the COP27 in Cairo.
            </p>
        ...
        <blockquote className="story-section-three-quote">
          ...
          <p>
            <span className="story-section-three-quote-line story-section-three-quote-line-desktop">
              &quot;I can&apos;t see climate action, peacebuilding, and resilience as three separate
              issues that plague
            </span>{' '}
            <span className="story-section-three-quote-line story-section-three-quote-line-desktop">
              Somalia simultaneously. Environmental crises such as floods and droughts often
              trigger
            </span>{' '}
            <span className="story-section-three-quote-line story-section-three-quote-line-desktop">
              conflicts over scarce resources. Building peace enables communities to focus on
              climate
            </span>{' '}
            <span className="story-section-three-quote-line story-section-three-quote-line-desktop">
              adaptation. In the meantime, strengthening climate resilience reduces the risk of new
            </span>{' '}
            <span className="story-section-three-quote-line story-section-three-quote-line-desktop">
      ...
      >
        <div className="story-section-three-details-copy">
          <span className="story-section-three-details-divider" aria-hidden="true" />

          <p>
            In Baladweyne, Maan-Dhis works with local communities, the government, and donors to
            develop flood-control systems and climate-smart agriculture solutions.
          </p>

          <p>
            Youth in Somalia generally face social and cultural barriers, including limited roles in
            decision-making and leadership, particularly for young women. Breaking through such
            barriers, Abdirahman focuses on youth empowerment and knowledge transfer.
          </p>

          <p>
            The Somalia Entrepreneurship Summit, which he organizes annually with Maan-Dhis, brings
            together government representatives, private sector leaders, refugees, academics, and
            youth innovators to promote local entrepreneurship.
          </p>

          <p>
            &quot;Maan-Dhis is unique in Somalia for being entirely youth-led and for bridging local
            and national leadership with international partners. As a result of youth advocacy, in
            2023, the government registered around 3,000 small enterprises.&quot;
          </p>

          <p>
            By 2025, 92 more youth-led enterprises were added to the registry, promising growth in
            entrepreneurship and innovation among the country&apos;s youth. Despite cultural and
            financial barriers, he described how Somali youth are breaking social taboos, building
            small enterprises, and gaining recognition from government and global partners alike.
          </p>
        </div>
      </section>
        ...
        <div className="story-vision-stage">
          <div className="story-vision-content">
            ...
            <p className="story-vision-copy" aria-label={visionCopy}>
              <span className="story-vision-lines story-vision-lines-desktop" aria-hidden="true">
                {renderVisionLines(visionDesktopLines)}
              </span>
              <span className="story-vision-lines story-vision-lines-mobile" aria-hidden="true">
          ...
          >
            <div className="story-leaders-grid">
              {storyLeaderImages.map((image, index) => {
                const leaderCardClass = `story-leader-card${
                  image.storyPath ? ' story-leader-card-link' : ''
                }`
